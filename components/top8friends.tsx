...
const Top8Friends = ({ products }) => {
	return (
		<div className="z-30  absolute   w-auto left-4 right-4  lg:w-[600px]   top-[-50px] lg:top-[120px] lg:left-[200px]">
			<div className=" bg-white border-2 border-[#ca6707] w-full relative mt-[270px] lg:mt-auto mb-[500px]">
