            ...
            <div className="z-30  absolute   w-auto left-4 right-4  lg:w-[600px]   top-[20%] lg:top-[220px] lg:left-[30px] mx-auto">
                <div className=" bg-white border-2 border-[#ca6707] w-full relative mt-[270px] lg:mt-auto ">
                    ...
                    <div className="mt-2 w-full p-4 over">
                        {cart?.contents.nodes.length === 0 && (<div className="text-center h-[300px] justify-center items-center flex overflow-hidden"><div className="h-[300px] w-full relative z-10"><Image
                            src="https://wp.clarksglassworks.com/wp-content/uploads/2024/01/MInL.gif"
                            alt=""
                            fill
                            className=""
                           /></div>
                ...
                <div className="flex justify-center"> <Image
                    src={'https://wp.clarksglassworks.com/wp-content/uploads/2024/01/giphy-2.gif'}
                    alt="Paypal"
                    width="200"
                    height="50"
                    style={{
